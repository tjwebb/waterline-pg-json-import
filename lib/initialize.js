...
function getDefaultsTo (column, json) {
  ...
  return convertType(column.column_default, getType(column.data_type));
}
 ...
 */
module.exports = function (json, connection) {
  var logfile = './build/initialize_'+ connection + '.json';
